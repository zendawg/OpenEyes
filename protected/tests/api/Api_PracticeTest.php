...
{
	protected $tag = 'http://openeyes.org.uk/fhir/tag/resource/Organization/Practice';
	...
	{
		$this->get('Organization?identifier=F002&_tag=' . urlencode($this->tag));
		$this->assertXPathEquals('feed', 'local-name()');
		$this->assertXPathEquals($this->client->getBaseUrl(), 'string(./atom:link[@rel="base"]/@href)');
		$this->assertXPathEquals($this->client->getBaseUrl() . '/Organization?identifier=F002&_tag=' . urlencode($this->tag), 'string(./atom:link[@rel="self"]/@href)');
