 ...
 */
    ...
    try {
        Yii::app()->controller->renderFile(Yii::app()->basePath . '/modules/GlaucomaVirtualClinic/views/default/view.php', array());
    } catch (Exception $e) {
        // If there is no extra episode summary detail page for this subspecialty we don't care
        // It might be that there is no glaucoma virtual clinic installed.
    }
?>
