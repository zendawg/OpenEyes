  ...
  <table cellpadding="2">
    ...
    <tr>
      ...
      <td>
        ...
        <button type="submit" style="margin-right: 10px; float: left; display: block;" class="classy blue tall" id="findPatient_id" tabindex="2"><span class="button-span button-span-blue"><?php echo $action ?></span></button>
      </td>
    </tr>
  </table>
</div>
