...
class ApiController extends CController
{
	...
	public function actionSearch($resource_type)
	{
		...
		$bundle = Service\Bundle::create("Search results", $self_url, $base_url, $indexed_resources);
	...
	{
		$this->sendResource(Service\OperationOutcome::singleIssue(FhirValueSet::ISSUESEVERITY_INFORMATION, null, $message), $status);
	}

	protected function sendError($message, $status = 400, $type = 0)
	{
		$this->sendResource(Service\OperationOutcome::singleIssue(FhirValueSet::ISSUESEVERITY_FATAL, $type, $message), $status);
	}
